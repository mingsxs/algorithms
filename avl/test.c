...
{
    int64_t array[12] = {65, 99, 53, 26, 9, 87, 42, 38, 18, 95, 12, 3};
    ...
    printf("%d predecessor is %lld\n", 42, (int64_t)AVLPREDECESSOR(at, (void *)42));
    printf("%d successor is %lld\n", 65, (int64_t)AVLPREDECESSOR(at, (void *)65));
    AVLTRAVERSE(at);
